...
const ApplicationProjects = () => {
  const [selectedService, setSelectedService] = useState('mobile-application');
      ...
      <div className='Main1'>
        <div className='main_page1'>
          <div className='project1'>
            ...
            <p> Application We offer </p>

          </div>
          <div className='project-togler1'>
            <select onChange={handleServiceChange} value={selectedService}>
              <option value='mobile-application'>Mobile Application</option>
              <option value='web-application'>Web Application</option>
              <option value='for-enterprices'>For-Enterprices</option>
            
            </select>
          </div>
        </div>

        {(selectedService === 'mobile-application' || selectedService === 'mobile-application') && (
          <>
            
            {item1 && ( 
            <div key={item1.id} className='our-work-card1' onClick={() => openModal(item1)}>
...
{item2 && ( 
            <div key={item2.id} className='our-work-card1' onClick={() => openModal(item2)}>
              <div className='work-content1'>
                <h1>{item2.title}</h1>
                <p>{item2.desc}</p>
              </div>
          ...
          {item3 && ( 
            <div key={item3.id} className='our-work-card1' onClick={() => openModal(item3)}>
              <div className='work-content1'>
                <h1>{item3.title}</h1>
                <p>{item3.desc}</p>
              </div>
          ...
          {item4 && ( 
            <div key={item4.id} className='our-work-card1'  onClick={() => openModal(item4)}>
              <div className='work-content1'>
                <h1>{item4.title}</h1>
                <p>{item4.desc}</p>
              </div>
          ...
          {item5 && ( 
            <div key={item5.id} className='our-work-card1'  onClick={() => openModal(item5)}>
              <div className='work-content1'>
                <h1>{item5.title}</h1>
                <p>{item5.desc}</p>
              </div>
          ...
          {item6 && (
            <div key={item6.id} className='our-work-card1'  onClick={() => openModal(item6)}>
              <div className='work-content1'>
                <h1>{item6.title}</h1>
                <p>{item6.desc}</p>
              </div>
        ...
        <Modal selectedItem={selectedItem} closeModal={() => setShowModal(false)} />
      )}
          </>
        )}
        ...
        {selectedService === 'web-application' && (
         ...
         {selectedService === 'for-enterprices' && (
          <>
            <div className='our-work-card1'>
              <div className='work-content1'>
                <h1>Food ordering Platform</h1>
